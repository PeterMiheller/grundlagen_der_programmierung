...
letters={
    ...
    'B':['speed','pensize','left90','forward40','circle-15/200','forward20','left180','circle-15/250','forward30','right180','forward50'],
    'C':['speed','pensize','up','forward30','down','circle25/-180','circle25/180'],
    ...
    'G':['speed','pensize','circle25/-180','up','circle25/180','down','circle15/100','left80','forward20','up','backward20','right80','circle15/-100','home','down'],
    ...
    'M':['speed','pensize','left90','forward45', 'right135','forward25','left90','forward25', 'right135','forward45','left90'],
    ...
    'U':['speed','pensize','left90','up','forward10','down','circle15/-180','left180','forward30','backward30','circle-15/-180','left180','forward30','backward30','up','backward15','right90','down'],
